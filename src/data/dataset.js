export default [
  ...
  },
  {
    ...
    imageUrl:
      "https://github.com/rubiestram/DEV012-dataverse/blob/main/src/data/images/alain_prost.png?raw=true",
    facts: {
      yearOfBirth: 1955,
  ...
  },
  {
    ...
    imageUrl:
      "https://github.com/rubiestram/DEV012-dataverse/blob/main/src/data/images/michael_shumacher.png?raw=true",
    facts: {
      yearOfBirth: 1969,
      yearOfDeath: "Sigue vivo",
  ...
  },
  {
    ...
    shortDescription:
      "Destacado piloto español con 2 campeonatos mundiales y un regreso emocionante a la Fórmula 1.",
    description:
      "Este destacado piloto español es reconocido por su impresionante carrera en la Fórmula 1. Ganador de dos campeonatos mundiales, es admirado por su habilidad en la pista y su enfoque incansable para alcanzar el éxito. Su versatilidad y capacidad para adaptarse a diferentes equipos y desafíos lo destacan como uno de los pilotos más respetados de su generación. Su regreso a la Fórmula 1 después de un retiro temporal emocionó a los fanáticos y demostró su pasión continua por las carreras.",
    imageUrl:
      "https://github.com/rubiestram/DEV012-dataverse/blob/main/src/data/images/fernando_alonso.png?raw=true",
    facts: {
      yearOfBirth: 1981,
      yearOfDeath: "Sigue vivo",
  ...
  },
  {
    ...
    name: "Lewis Hamilton",
    shortDescription:
      "Piloto británico con múltiples campeonatos mundiales y un compromiso por la igualdad y el activismo.",
    description:
    ...
    imageUrl:
      "https://github.com/rubiestram/DEV012-dataverse/blob/main/src/data/images/lewis_hamilton.png?raw=true",
    facts: {
      yearOfBirth: 1985,
      yearOfDeath: "Sigue vivo",
  ...
  },
  {
    ...
    shortDescription:
      "Piloto brasileño con 2 campeonatos mundiales y un legado en la Fórmula 1 y las carreras de autos.",
    description:
    ...
    imageUrl:
      "https://github.com/rubiestram/DEV012-dataverse/blob/main/src/data/images/emerson_fittipaldi.png?raw=true",
    facts: {
      yearOfBirth: 1946,
      yearOfDeath: "Sigue vivo",
      placeOfBirth: "São Paulo, Brasil",
  ...
  },
  {
    ...
    name: "Jack Brabham",
    shortDescription:
      "Piloto australiano con 3 campeonatos mundiales, influyó en las carreras de autos como piloto y constructor.",
    description:
      "Ganador de 3 campeonatos mundiales, su destreza en la pista lo convirtió en un verdadero campeón. Era conocido por su espíritu competitivo y su dedicación al automovilismo. Su contribución al deporte perdura, y su nombre es sinónimo de éxito y perseverancia en las carreras de autos. Brabham, con su enfoque innovador, cambió la forma en que se abordaba la ingeniería en la Fórmula 1 y estableció un legado duradero en el automovilismo. Su influencia como piloto y constructor sigue siendo relevante en la historia de las carreras.",
    imageUrl:
      "https://github.com/rubiestram/DEV012-dataverse/blob/main/src/data/images/jack_brabham.png?raw=true",
    facts: {
      yearOfBirth: 1926,
      yearOfDeath: 2014,
  ...
  },
  {
    ...
    name: "Jacky Ickx",
    shortDescription:
      "Piloto belga destacado en resistencia y Fórmula 1, con logros notables en las 24 Horas de Le Mans.",
    description:
      "Destacó en la Fórmula 1 y eventos de resistencia a partir de principios de la década de 1960. Sus victorias más notables se produjeron en las 24 Horas de Le Mans, donde obtuvo múltiples triunfos y estableció récords. A lo largo de su carrera, compitió en diferentes escuderías, mostrando su versatilidad y adaptabilidad. Su meticuloso enfoque táctico y valentía bajo condiciones extremas, como el Gran Premio de Francia de 1969, lo convirtieron en un piloto respetado. Ickx es un ícono del automovilismo belga y una inspiración para pilotos posteriores, dejando un legado duradero en el deporte de motor.",
    imageUrl:
      "https://github.com/rubiestram/DEV012-dataverse/blob/main/src/data/images/jacky_ickx.png?raw=true",
    facts: {
      yearOfBirth: 1945,
      yearOfDeath: "Sigue vivo",
  ...
  },
  {
    ...
    name: "Graham Hill",
    shortDescription:
      "Piloto británico con 2 campeonatos mundiales en Fórmula 1 y una personalidad carismática en las pistas.",
    description:
    ...
    imageUrl:
      "https://github.com/rubiestram/DEV012-dataverse/blob/main/src/data/images/graham_hill.png?raw=true",
    facts: {
      yearOfBirth: 1929,
      yearOfDeath: 1975,
      placeOfBirth: "Londres, Reino Unido",
  ...
  },
  {
    ...
    name: "Mika Häkkinen",
    shortDescription:
      "Piloto finlandés de Fórmula 1, es conocido por sus 2 campeonatos mundiales y su destreza en las pistas.",
    description:
      "Eforjó su camino con determinación y talento. Debutó en 1991 con Lotus y enfrentó desafíos iniciales. Sin embargo, su apogeo llegó en McLaren, ganando dos campeonatos mundiales en 1998 y 1999. Su enfoque meticuloso y manejo en situaciones de alta presión lo convirtieron en un competidor formidable. Trágicamente, en 2001, sorprendió al mundo anunciando su retiro. Aunque regresó brevemente en 2002, nunca volvió a competir a tiempo completo. Su retiro marcó el final de una era en la Fórmula 1, dejando un legado de respeto y carisma en el deporte de motor.",
    imageUrl:
      "https://github.com/rubiestram/DEV012-dataverse/blob/main/src/data/images/mika_hakkinen.png?raw=true",
    facts: {
      yearOfBirth: 1968,
      yearOfDeath: "Sigue vivo",
  ...
  },
  {
    ...
    shortDescription:
      "joven piloto monegasco de Fórmula 1, es una de las promesas más brillantes del deporte, compitiendo para Ferrari",
    description:
      "Debutó en 2018 con Sauber y en 2019 se unió a Ferrari, donde ha deslumbrado con su estilo de conducción agresivo y valentía en situaciones complicadas. Su capacidad para competir en la lucha por el campeonato lo convierte en uno de los pilotos más emocionantes de la parrilla. A pesar de su juventud, Leclerc ya ha dejado una marca significativa en la Fórmula 1 y promete un futuro brillante en el deporte de motor, siendo una fuente de emoción para los fanáticos de todo el mundo.",
    imageUrl:
      "https://github.com/rubiestram/DEV012-dataverse/blob/main/src/data/images/charles_leclerc.png?raw=true",
    facts: {
      yearOfBirth: 1997,
      yearOfDeath: "Sigue vivo",
  ...
  },
  {
    ...
    name: "Jenson Button",
    shortDescription:
      "Piloto británico de Fórmula 1, es conocido por su carisma y su campeonato mundial en 2009.",
    description:
    ...
    imageUrl:
      "https://github.com/rubiestram/DEV012-dataverse/blob/main/src/data/images/jenson_button.png?raw=true",
    facts: {
      yearOfBirth: 1980,
      yearOfDeath: "Sigue vivo",
  ...
  },
  {
    ...
    name: "Nico Rosberg",
    shortDescription:
      "Ex piloto alemán de Fórmula 1, conocido por ganar el campeonato mundial en 2016 y su rivalidad con Lewis Hamilton.",
    description:
    ...
    imageUrl:
      "https://github.com/rubiestram/DEV012-dataverse/blob/main/src/data/images/nico_rosberg.png?raw=true",
    facts: {
      yearOfBirth: 1985,
      yearOfDeath: "Sigue vivo",
  ...
  },
  {
    ...
    name: "Kimi Räikkönen",
    shortDescription:
      "Piloto finlandés de Fórmula 1, es conocido por su apodo Iceman y su campeonato mundial en 2007.",
    description:
    ...
    imageUrl:
      "https://github.com/rubiestram/DEV012-dataverse/blob/main/src/data/images/kimi_raikkonen.png?raw=true",
    facts: {
      yearOfBirth: 1979,
      yearOfDeath: "Sigue vivo",
  ...
  },
  {
    ...
    name: "Stefan Bellof",
    shortDescription:
      "Piloto alemán, es recordado por su destreza en la Fórmula 1 y su trágica muerte en un accidente.",
    description:
    ...
    imageUrl:
      "https://github.com/rubiestram/DEV012-dataverse/blob/main/src/data/images/stefan_bellof.png?raw=true",
    facts: {
      yearOfBirth: 1957,
      yearOfDeath: 1985,
  ...
  },
  {
    ...
    name: "Lance Stroll",
    shortDescription:
      "El joven piloto de Fórmula 1 es conocido por su participación en el equipo Aston Martin.",
    description:
      "Ha demostrado su valía en las pistas con su entrada en el equipo de Fórmula 1. Hijo de Lawrence Stroll, propietario del equipo Racing Point (ahora Aston Martin), Lance ingresó a la Fórmula 1 en 2017 con Williams y luego se unió al equipo de su familia. Su juventud y determinación lo han llevado a competir en un deporte altamente competitivo.Sigue evolucionando como piloto y su futuro en el deporte promete un potencial emocionante. Su participación en el equipo Aston Martin marca una nueva etapa en su carrera.",
    imageUrl:
      "https://github.com/rubiestram/DEV012-dataverse/blob/main/src/data/images/lance_stroll.png?raw=true",
    facts: {
      yearOfBirth: 1998,
      yearOfDeath: "Sigue vivo",
  ...
  },
  {
    ...
    name: "Guanyu Zhou",
    shortDescription:
      "Piloto chino ha impactado en la Fórmula 1 con su participación en el equipo Alfa Romeo",
    description:
      "Talentoso piloto de Fórmula 1, ha dejado una impresión en el deporte con su participación en el equipo Alfa Romeo. Su carrera en la Fórmula 1 comenzó en 2022, convirtiéndose en el primer piloto chino en competir en la máxima categoría. Zhou ha demostrado su destreza en las pistas y su dedicación al automovilismo. Su paso por la Fórmula 2 lo preparó para la Fórmula 1, y su futuro en el deporte promete ser emocionante. Como un embajador del automovilismo chino, Zhou ha atraído la atención de fanáticos de todo el mundo.",
    imageUrl:
      "https://github.com/rubiestram/DEV012-dataverse/blob/main/src/data/images/zhou_guanyu.png?raw=true",
    facts: {
      yearOfBirth: 1999,
      yearOfDeath: "Sigue vivo",
  ...
  },
  {
    ...
    name: "Lando Norris",
    shortDescription:
      "Joven piloto británico ha dejado una huella en la Fórmula 1 con su estilo audaz y su participación en McLaren.",
    description:
    ...
    imageUrl:
      "https://github.com/rubiestram/DEV012-dataverse/blob/main/src/data/images/lando_norris.png?raw=true",
    facts: {
      yearOfBirth: 1999,
      yearOfDeath: "Sigue vivo",
  ...
  },
  {
    ...
    name: "Oscar Piastri",
    shortDescription:
      "Joven piloto australiano ha impresionado en la Fórmula 1 con su ascenso meteórico.",
    description:
      "Joven piloto australiano, que ha sorprendido a todos con su ascenso meteórico en el mundo de la Fórmula 1. Su debut en el equipo Alpine en 2022 marcó el comienzo de una prometedora carrera en la máxima categoría del automovilismo. Antes de llegar a la Fórmula 1, Piastri se destacó en las categorías de monoplazas, demostrando su destreza en las pistas y su determinación por alcanzar la cima. Su futuro en el deporte es motivo de emoción y su legado en la Fórmula 1 está en proceso de crecimiento.",
    imageUrl:
      "https://github.com/rubiestram/DEV012-dataverse/blob/main/src/data/images/oscar_piastri.png?raw=true",
    facts: {
      yearOfBirth: 2001,
      yearOfDeath: "Sigue vivo",
  ...
  },
  {
    ...
    name: "Yuki Tsunoda",
    shortDescription:
      "Piloto japonés que ha impresionado en la Fórmula 1 con su ascenso rápido y su participación en AlphaTauri.",
    description:
      "Joven piloto japonés de Fórmula 1, ha impresionado a todos con su ascenso rápido en el deporte. Su debut en AlphaTauri en 2021 marcó el inicio de una emocionante carrera en la máxima categoría del automovilismo. Antes de su llegada a la Fórmula 1, Tsunoda dejó su marca en las categorías de monoplazas, demostrando su destreza en las pistas y su determinación por alcanzar el éxito. Su futuro en el deporte es motivo de entusiasmo, y su legado en la Fórmula 1 sigue creciendo.",
    imageUrl:
      "https://github.com/rubiestram/DEV012-dataverse/blob/main/src/data/images/yuki_tsunoda.png?raw=true",
    facts: {
      yearOfBirth: 2000,
      yearOfDeath: "Sigue vivo",
  ...
  },
  {
    ...
    name: "Logan Sargeant",
    shortDescription:
      "joven piloto estadounidense de automovilismo con un futuro prometedor en la Fórmula 1.",
    description:
      "Talentoso piloto de automovilismo nacido en St. Petersburg, Florida, que ha llamado la atención con su ascendente carrera en el deporte. Sus inicios en el karting sentaron las bases de su éxito, y desde entonces ha demostrado su destreza en las categorías de monoplazas. Compitiendo en campeonatos como la Fórmula 3, Fórmula 2 y Formula 1, Sargeant ha acumulado experiencia y habilidades al volante. Su futuro promete seguir siendo brillante en el automovilismo, y muchos esperan verlo en la Fórmula 1 en un futuro cercano.",
    imageUrl:
      "https://github.com/rubiestram/DEV012-dataverse/blob/main/src/data/images/logan_sargeant.png?raw=true",
    facts: {
      yearOfBirth: 2000,
      yearOfDeath: "Sigue vivo",
